...
const LectureTab = () => {
    ...
    const fileChangeHandler = async (e) => {
        ...
        if (file) {
            ...
            try {
                const res = await axios.post(`http://localhost:5000/api/v1/media/upload-video`, formData, {
    ...
    const editLectureHandler = async (e) => {
        ...
        try {
            setLoading(true)
            const res = await axios.post(`http://localhost:5000/api/v1/course/${courseId}/lecture/${lectureId}`, data, {
                headers: {
    ...
    const removeLectureHandler = async (e) => {
        ...
        try {
            ...
            const res = await axios.delete(`http://localhost:5000/api/v1/course/lecture/${lectureId}`, { withCredentials: true })
            if (res.data.success) {
