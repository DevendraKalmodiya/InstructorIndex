...
const Navbar = () => {
  ...
  return (
    <div className="bg-gray-900 z-50 w-full py-3 fixed top-0">
      <div className="max-w-7x1 mx-auto flex justify-between">
        {/* logo section */}
        <Link to="/">
          <div className="flex gap-1">
            <GraduationCap className="text-gray-300 w-10 h-10" />
            <h1 className="text-gray-300 text-3x1 font-bold">Logo</h1>
          </div>
        </Link>

        {/* menu section */}
        <nav>
          <ul className="flex gap-7 text-xl items-centre font-semibold text-white">
            <Link to="/">
